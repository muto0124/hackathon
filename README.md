...
T-AI-DA は、比較リストを増やすのではなく、低リスクな日常判断を AI に委任する体験を作ります。ユーザーは「どれにするか」を考える代わりに、T-AI-DA が決めた 1 つの提案を受け取り、必要な準備へ移ることができます。
...
```mermaid
flowchart LR
    L1["Level 1\n提案\nユーザーが実行"] -->|承認を重ねる| L2["Level 2\n半自動\n準備まで完了"] -->|委任を重ねる| L3["Level 3\n低リスク自動化\n先回りで完了"]
...
**07:00 — 朝のプランが届く（怠惰レベル 1）**

> 「おはようございます。今日は 14 時に外出予定、夕方から雨です。
>
> 服装はジャケット着用、夕食は近所のスーパーで鶏鍋の材料を。
> 買い物リストは下に用意しました。」

天気・予定・好み・予算をもとに、食事・服装・買い物候補・夜の過ごし方を一択で提示します。ユーザーは比較しません。

**12:30 — 昼食で迷う（即決ボタン）**

> 「オフィス近くの定食屋 B にしてください。混む前に 12:15 に出ると快適です。」

迷いを入力すると、T-AI-DA が 1 つの答えと短い理由を返します。

**21:00 — 5 回目の承認（怠惰レベル 2 へ）**

> 「怠惰レベルが 2 になりました。今後は買い物リストまで私が決めます。
>
> 少しずつ、あなたの判断筋を預からせていただきます。」

委任を重ねるほど T-AI-DA が先回りする範囲が広がります。安全境界を超える判断は、怠惰レベルが上がっても自動化しません。
